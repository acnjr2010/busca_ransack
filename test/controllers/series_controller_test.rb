...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference('Series.count') do
      post series_index_url, params: { series: { kind: @series.kind, name: @series.name, seasons: @series.seasons, subtitle: @series.subtitle, year: @series.year } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { kind: @series.kind, name: @series.name, seasons: @series.seasons, subtitle: @series.subtitle, year: @series.year } }
